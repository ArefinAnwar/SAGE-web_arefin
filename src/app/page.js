...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div id='hero-section' className="h-[50rem] lg:h-auto lg:min-h-screen scrollbar-hide overflow-y-hidden ">
        <HeroSection />
      </div>
      ...
      <div id="how-to-use" className="h-[110rem]  md:h-auto overflow-y-hidden scrollbar-hide md:min-h-screen">
        <HowToUseSage />
      </div>

...
export default function PCNavbar({ className }) {
  return (
    <nav
      className={cn(
        "invisible md:visible border-[1px] fixed top-3 text-white bg-slate-800/90 flex w-[50%] rounded-md inset-x-0 mx-auto items-center justify-center py-2 px-2  flex-row z-50",
        className
      )}
    >
      <Image
